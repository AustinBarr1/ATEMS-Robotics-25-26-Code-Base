...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      {"10 Main Match auton(uses both sides)", fullautonomous},
      {"Right Side Match Auton", rightsideautonomous},
      {"Left Side Match Auton", leftsideautonomous},
